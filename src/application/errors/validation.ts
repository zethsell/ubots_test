...
export class RequiredFieldError extends Error {
  constructor(fieldName?: string) {
    const message = fieldName === undefined ? 'Field required' : `O campo ${fieldName} é obrigatório!`
    super(message)
...
export class ContentNotFound extends Error {
  constructor(fieldName?: string) {
    const message = fieldName === undefined ? 'Content not found' : `Not found any ${fieldName}`
    super(message)
