...
import { PgDataSource } from '@/main/config'
import { ConnectionError, ConnectionNotFoundError } from '.'
...
export class PgConnection {
  ...
  async connect(): Promise<void> {
    this.connection = this.connection === undefined ? await this.initialize() : this.connection
  }
